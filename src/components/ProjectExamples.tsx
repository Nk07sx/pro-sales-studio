        ...
        <div className="space-y-6 md:space-y-10">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute -top-3 -right-3 md:-top-4 md:-right-4 bg-primary text-white px-4 py-2 rounded-full shadow-xl text-sm md:text-base z-20 border-2 border-background">

      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          <div className="inline-block px-4 py-2 bg-primary/10 rounded-full border border-primary/20 mb-4">
            <span className="text-sm font-medium text-primary">🚀 Transforme seu negócio hoje</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto">
            Automatize processos, economize tempo e multiplique seus resultados com a plataforma mais completa do mercado
          </p>
